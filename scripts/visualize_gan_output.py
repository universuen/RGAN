...
if __name__ == '__main__':
    ...
    for dataset_name in datasets:
        ...
        dataset = src.datasets.MinorityDataset(training=True)
        src.utils.set_random_state()
        vae = src.VAE()
        ...
        src.utils.set_random_state()
        gan = TARGET_GAN(vae.encoder)
        gan.train(
            minority_roulette_dataset=src.datasets.MinorityRouletteDataset(training=True),
            majority_dataset=src.datasets.MajorityDataset(training=True),
        )
