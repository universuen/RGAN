...
from src.models import EncoderModel, DecoderModel
...
class VAE:
    ...
    def _save_model(self):
        encoder_path = config.path.models / f'{self.__class__.__name__}_encoder.pt'
        torch.save(self.encoder.state_dict(), encoder_path)
        self.logger.debug(f'Saved encoder model at {encoder_path}')

        decoder_path = config.path.models / f'{self.__class__.__name__}_decoder.pt'
